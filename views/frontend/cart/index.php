<div class="row title">
    ...
    <?php if(isset($_SESSION['cus_id'])):?>
        <button onclick="load_order();" class="btn widget-blue ord-btn_load">My order</button>
    <?php endif;?>
</div>
        ...
        <table id="cart" class="table table-hover table-condensed">
            ...
            <tfoot>
                ...
                <tr style="color: black;">
                    ...
                    <td colspan="4"><button onclick="<?=isset($_SESSION['cus_id']) ? 'load_payment();': 'redirect_login()';?>" id="payment" class="btn btn-success" style="float: right; font-weight: 600; color: white; padding: 12px 32px;">Payment <i class="fa fa-angle-right"></i></button></td>
                </tr>
            </tfoot>
        </table>
    <?php else : ?>
