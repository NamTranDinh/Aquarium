...
#error-page-bsw {
 ...
 padding: 0!important;
 z-index: 999;
 background: url(/Aquarium/public/templates/image/background_404.jpg) no-repeat center center!important;
...
<div id='error-page-bsw'>
    <div class='meta_'>
        ...
        <div class='intro_label'>
            ...
            <p>Lỗi " Page not found! ", sao bạn lạc trôi tới đây được vậy!?</p>
            <a class='btn-error-page' href='/Aquarium/views/frontend/'>Về trang chủ</a>
            <a class='btn-error-page' href='#' onclick='goBack()'>Quay lại trang trước</a>
            </div>
        </div>
    </div>
</div>
